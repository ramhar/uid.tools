...
import static ua.net.uid.utils.tools.DailyEquation.*;
...
public class DailyEquationTest {
    ...
    public void testGetSunEvents() throws ParseException {
        ...
        assertEvents("Antarctica/McMurdo", "20150621", -77.8456, 166.6693, Zenith.OFFICIAL, Type.POLAR_NIGHT, null, null);
        assertEvents("Antarctica/McMurdo", "20150921", -77.8456, 166.6693, "06:49", "18:47");
        assertEvents("Antarctica/McMurdo", "20151221", -77.8456, 166.6693, Zenith.OFFICIAL, Type.POLAR_DAY, null, null);
        ...
        assertEvents("America/Moscow", "20181202", 69.000779, 33.116392, Zenith.OFFICIAL, Type.POLAR_NIGHT, null, null);
        assertEvents("America/Moscow", "20190111", 69.000779, 33.116392, Zenith.OFFICIAL, Type.POLAR_NIGHT, null, null);
    ...
    private void assertEvents(String timezone, String date, double lat, double lon, String sr, String ss) throws ParseException {
        assertEvents(timezone, date, lat, lon, Zenith.OFFICIAL, Type.NORMAL_DAY, sr, ss);
    }
    private void assertEvents(String timezone, String date, double lat, double lon, Zenith zenith, Type type, String sr, String ss) throws ParseException {
        ...
        Events events = DailyEquation.getSunEvents(lat, lon, calendar, zenith);
        
        assertSame(type, events.getType());
        if (type == Type.NORMAL_DAY) {
